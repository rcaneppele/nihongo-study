  ...
  return (
    <div className="space-y-10">
      ...
      <Section title="Primeira pessoa — 'eu'">
        <GrammarTable
          headers={['Pronome', 'Gênero / registro', 'Quando usar']}
          jpCols={[0]}
          rows={[
            ['わたし', 'neutro / padrão', 'Mais versátil. Seguro em qualquer situação.'],
            ['わたくし', 'neutro / muito formal', 'Discursos, contextos formais, negócios de alto nível.'],
            ['ぼく', 'masculino / casual a semi-formal', 'Homens em situações informais ou semi-formais.'],
            ['おれ', 'masculino / casual, rude ou íntimo', 'Entre amigos próximos do mesmo gênero. Evite em contextos formais.'],
            ['あたし', 'feminino / casual', 'Mulheres em conversas informais.'],
            ['あたくし', 'feminino / muito formal', 'Versão muito formal de あたし, menos comum.'],
            ['うち', 'feminino / bem casual', 'Dialeto Kansai. Jovens femininas no Kansai e na cultura pop.'],
          ]}
        />
        <Note>
      ...
      <Section title="Formas plurais de 'nós'">
        <GrammarTable
          headers={['Pronome', 'Base + sufixo', 'Registro']}
          jpCols={[0, 1]}
          rows={[
            ['わたしたち', 'わたし + たち', 'neutro, padrão'],
            ['わたしども', 'わたし + ども', 'muito formal, humilde'],
            ['ぼくたち / ぼくら', 'ぼく + たち / ら', 'masculino casual'],
            ['おれたち / おれら', 'おれ + たち / ら', 'masculino, muito casual'],
            ['あたしたち', 'あたし + たち', 'feminino casual'],
          ]}
        />
        <Note>
      ...
      <Section title="Segunda pessoa — 'você'">
        <GrammarTable
          headers={['Pronome', 'Registro', 'Atenção']}
          jpCols={[0]}
          rows={[
            ['あなた', 'neutro / formal', 'Correto gramaticalmente, mas pode soar distante, frio ou condescendente entre iguais.'],
            ['きみ', 'casual / superior→inferior', 'De um superior ou professor para subordinado. Muito comum em letras de músicas.'],
            ['おまえ', 'muito casual / rude', 'Entre íntimos do mesmo gênero. Pode ofender fortemente se mal usado.'],
            ['あんた', 'casual / levemente rude', 'Versão informal de あなた. Pode soar brusco dependendo do tom.'],
            ['そちら', 'muito formal', 'Forma educada de "você / vocês" em atendimento formal.'],
          ]}
        />
        <Note>
          <strong>A melhor prática:</strong> japoneses evitam a segunda pessoa usando o nome da
          pessoa + さん/せんせい, ou o título dela (ぶちょう, sensei, etc.). Se você não sabe o nome, あなた é
          gramaticalmente correto mas pode soar frio. Em muitos casos, simplesmente omita o pronome
          — o contexto é suficiente.
        </Note>
        <Ex jp="たなかさんはコーヒーをのみますか？" pt="(Você,) sr. Tanaka, toma café?" notes="mais natural do que usar あなた" />
        <Ex jp="せんせい、しつもんがあります。" pt="Professor, tenho uma pergunta." notes="o professor é endereçado pelo título, não por あなた" />
      </Section>

      <Section title="Formas plurais de 'vocês / todos'">
        <GrammarTable
          headers={['Pronome', 'Registro', 'Uso']}
          jpCols={[0]}
          rows={[
            ['あなたたち', 'neutro', 'Raro na fala; mais comum na escrita'],
            ['あなたがた', 'formal / respeitoso', 'Discursos formais, "vocês" com respeito'],
            ['きみたち', 'casual / superior→inferior', 'Professor falando com turma, treinador com equipe'],
            ['みなさん', 'neutro / semi-formal', 'O mais comum: "everyone", qualquer contexto'],
            ['みなさま', 'muito formal', 'Cerimônias, discursos, anúncios formais'],
            ['みんな', 'casual', 'Conversa diária: "todo mundo"'],
          ]}
        />
        <Ex jp="みなさん、よろしいですか？" pt="Todo mundo está bem? (Posso começar?)" notes="professor perguntando à turma" />
        <Ex jp="みなさま、ほんじつはおこしいただきありがとうございます。" pt="Senhoras e senhores, obrigado por virem hoje." notes="discurso formal" />
      </Section>

      <Section title="Terceira pessoa — 'ele / ela / eles'">
        <GrammarTable
          headers={['Pronome', 'Significado', 'Atenção']}
          jpCols={[0]}
          rows={[
            ['かれ', 'ele', 'Também significa "namorado". Cuidado com ambiguidade.'],
            ['かのじょ', 'ela', 'Também significa "namorada". Igualmente ambíguo.'],
            ['かれら', 'eles (masc./misto)', 'Plural de かれ.'],
            ['かのじょたち', 'elas', 'Plural de かのじょ.'],
            ['あのひと', 'aquela pessoa', 'Mais neutro e natural. Não implica gênero.'],
            ['あのかた', 'aquela pessoa (respeitoso)', 'Versão formal de あのひと.'],
            ['あいつ', 'aquele (rude)', 'Informal e levemente depreciativo.'],
            ['こいつ / そいつ', 'este / esse (rude)', 'Muito informal, usado em frustração ou entre íntimos.'],
          ]}
        />
        <Note>
      ...
      <Section title="じぶん — 'si mesmo', 'eu mesmo'">
        <p className="text-sm leading-relaxed text-ink">
          <strong className="font-jp">じぶん</strong> é o pronome reflexivo do japonês.
        ...
        <Ex jp="じぶんでやります。" pt="Faço eu mesmo. / Faço por conta própria." />
        <Ex jp="じぶんのことをはなしてください。" pt="Por favor, fale sobre você mesmo." />
        <Ex jp="かれはじぶんのことしかかんがえない。" pt="Ele só pensa em si mesmo." notes="じぶん como reflexivo de 'ele'" />
        <Note>
      ...
      <Section title="A omissão de pronomes — o princípio mais importante">
        ...
        <GrammarTable
          ...
          jpCols={[0, 1]}
          rows={[
            ['わたしはどこにいきますか？', 'どこにいきますか？', 'Onde você vai?'],
            ['わたしはコーヒーがすきです。', 'コーヒーがすきです。', 'Gosto de café.'],
            ['あなたはどうおもいますか？', 'どうおもいますか？', 'O que você acha?'],
            ['わたしはたなかです。', 'たなかです。', 'Sou Tanaka.'],
          ]}
        />
        <Ex jp="A：きのう、なにをしましたか？　B：えいがをみました。" pt="A: O que você fez ontem? B: Assisti a um filme." notes="B não precisa de pronome — contexto é claro" />
        <Ex jp="おなかがすいたね。なにかたべる？" pt="Estou com fome, né? Quer comer algo?" notes="nem sujeito nem objeto — contexto diz tudo" />
      </Section>
      ...
      <Section title="Quando incluir o pronome (uso enfático)">
        ...
        <Ex jp="わたしがいきます。（ほかのひとじゃなく）" pt="Vou eu (não outra pessoa)." notes="が com pronome = ênfase forte em quem" />
        <Ex jp="あなたにたのんでいるんです。" pt="Estou pedindo a você (especificamente)." />
        <Ex jp="わたしはコーヒー、あなたはこうちゃね。" pt="Eu vou de café, você de chá, né?" notes="は com contraste — aqui os pronomes são necessários" />
      </Section>
      ...
      <Section title="Pronomes em anime vs vida real">
        ...
        <GrammarTable
          ...
          rows={[
            ...
            ['きさま', '"Você miserável!" — antagonistas com raiva', 'Praticamente inexistente na fala cotidiana real'],
            ['せっしゃ', 'Personagens samurai em dramas históricos', 'Inexistente na fala moderna'],
          ]}
        />
        <Note>
      ...
      <Section title="Pronomes históricos e literários">
        ...
        <GrammarTable
          headers={['Pronome', 'Significado', 'Contexto']}
          jpCols={[0]}
          rows={[
            ['われ / が', 'eu (literário)', 'Poesia clássica, discursos solenes, RPGs'],
            ['わが', 'meu / nosso (literário)', 'わがくに (meu país), わがいえ (minha casa)'],
            ['そなた / そち', 'você (arcaico, respeitoso)', 'Dramas históricos feudais'],
            ['なんじ', 'você (arcaico, bíblico)', 'Textos religiosos ou solenes'],
            ['かれ (こご)', 'aquele (pronome demonstrativo, não pessoal)', 'Japonês clássico; diferente do moderno かれ'],
          ]}
        />
      </Section>
        ...
        <GrammarTable
          ...
          rows={[
            ...
            [
              ...
              'Numa reunião de trabalho: "おれはそうおもいます。"',
              '"わたしはそうおもいます。"',
